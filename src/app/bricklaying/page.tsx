  ...
  return (
    <section id='about' className='relative w-[100%] min-h-[500px] flex justify-center bg-[#161616] pt-[40px] md:pt-[100px]'>
      ...
      <div className='w-[95%] max-w-[1880px] relative z-2 pt-[30px] pb-[30px] grid grid-cols-12 auto-rows-min gap-[10px]'>
        ...
        <div className='relative pb-[2rem] col-span-12 md:col-span-8 md:col-start-3'>
          <h4 className='font-bold text-[white]'>Bricklaying Course</h4><br />
        ...
        <div className="col-span-12 row-start-2 md:col-span-8 md:col-start-3 bg-[black] p-[2rem] border border-[black] rounded-[5px] bg-gradient-to-br from-[#FABC3C] to-[#FACC6B]">
          ...
          <p className='text-[black]'>This intensive 5-day bricklaying course is designed for individuals looking to gain practical skills and knowledge in bricklaying. Participants will learn essential techniques and safety protocols while constructing various types of walls and installing lintels.</p>
          <br />
