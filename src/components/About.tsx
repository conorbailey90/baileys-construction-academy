    ...
    <section id='about' className=' relative w-[100%] min-h-[500px] flex justify-center bg-[#161616] pt-[40px] md:pt-[100px]'>
        ...
        <div className='w-[95%] max-w-[1880px] relative z-2 pt-[30px] pb-[30px] grid grid-cols-12 auto-rows-min gap-[10px]'>
            ...
            <div className=' pb-[2rem] col-start-1 col-span-12 md:col-start-7 md:col-span-6 row-start-1'>
                ...
                <p className='text-balance'>Welcome to Essex Bricklaying & Plastering School, where we&apos;re focused on helping you gain practical skills in bricklaying and plastering. Whether you&apos;re looking to pursue a career in these trades or simply want to learn for your own DIY projects, our school offers hands-on training for all levels.</p><br />
                ...
                <ul><br />
                    ...
                    <li className='flex items-center'><Check width={'30px'} color='rgb(252,186,3)' className='mr-[1rem]' /><p> <span className='font-semibold'>Practical Hands-On Training:</span> Our courses are designed to give you real-world experience, whether you&apos;re just starting out or looking to sharpen your skills. You&apos;ll have the chance to work with the tools and materials used in the industry.</p></li><br />
