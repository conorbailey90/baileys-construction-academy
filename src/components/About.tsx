    ...
    <section className=' relative w-[100%] min-h-[500px] flex justify-center bg-[#161616]'>
        ...
        <div className='w-[95%] max-w-[1880px] relative z-2 pt-[30px] pb-[30px] grid grid-cols-12 auto-rows-min gap-[10px]'>
            ...
            <div className=' pb-[2rem] col-start-1 col-span-12 md:col-start-7 md:col-span-6 row-start-1'>
                ...
                <p>Welcome to the Bricklaying and Plastering Academy, where we’re dedicated to shaping the next generation of construction professionals. Based in Essex, our academy is a hub of excellence for anyone looking to master the skills of bricklaying and plastering.</p><br />
                <p>Our mission is simple: to provide top-notch training that combines hands-on experience with industry-leading knowledge. We believe that great craftsmanship starts with a solid education, and we’re here to offer you both.</p><br />
