  ...
  return (
    <footer id='footer' className=' relative w-[100%] min-h-[300px] flex justify-center bg-[black]'>
        <div className='w-[95%] max-w-[1880px] relative z-2 pt-[30px] pb-[30px] grid grid-cols-12 auto-rows-min gap-[10px]'>
            ...
            <h6 style={{fontSize: '1rem', fontFamily: 'montserrat', fontWeight: 'bold', letterSpacing: '-.05em'}} className="flex col-span-3 items-center uppercase text-[rgb(252,186,3)]">Essex Bricklaying & Plasterings School</h6>
